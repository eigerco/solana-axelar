...
import { AXELAR_SOLANA_ITS_PROGRAM_ID as PROGRAM_ID } from "@native-to-anchor/axelar-solana-generated/its";
...
export function findItsRootPda(gatewayRootPda: PublicKey): [publicKey: PublicKey, bump: number] {
...
export function canonicalInterchainTokenDeploySalt(mint: PublicKey): Uint8Array {
    return keccak_256(
        new Uint8Array([...Buffer.from(PREFIX_CANONICAL_TOKEN_SALT), ...mint.toBytes()])
    );
}

export function interchainTokenDeployerSalt(deployer: PublicKey, salt: Uint8Array): Uint8Array {
    return keccak_256(
        new Uint8Array([...Buffer.from(PREFIX_INTERCHAIN_TOKEN_SALT), ...deployer.toBytes(), ...salt])
    );
}

export function linkedTokenDeployerSalt(deployer: PublicKey, salt: Uint8Array): Uint8Array {
    return keccak_256(
        new Uint8Array([...Buffer.from(PREFIX_CUSTOM_TOKEN_SALT), ...deployer.toBytes(), ...salt])
    );
}
...
export function interchainTokenId(deployer: PublicKey, salt: Uint8Array): Uint8Array {
...
export function linkedTokenId(deployer: PublicKey, salt: Uint8Array): Uint8Array {
